...
public class TerminalClient {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Client client = new Client("69100", new Date(2002,02,02), "DURIF", "Sylvain", "john.doe@example.com", 'H', "password", "1234567890");
        ...
        Client client2 = new Client("69006", new Date(1789,02,02), "HENNI", "Mohammed", "mohammed.henni@om.fr", 'H', "jeVaisToutCasser", "1234567890");
