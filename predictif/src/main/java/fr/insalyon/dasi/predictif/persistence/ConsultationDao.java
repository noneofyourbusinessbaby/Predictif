...
public class ConsultationDao {
    ...
    public Consultation getConsultationEnCours(Employe employe) {
        ...
        try {
            EntityManager em = JpaUtil.obtenirContextePersistance();
            TypedQuery<Consultation> query = em.createQuery("SELECT c FROM Consultation c WHERE c.employe = :employe AND c.dateDebut IS NULL AND c.dateFin IS NULL", Consultation.class);
